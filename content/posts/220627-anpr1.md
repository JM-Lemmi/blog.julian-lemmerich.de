...
title = "A Journey of Automatic Number Plate Recognition 1: OpenALPR"
date = 2022-06-27
summary = "In the first article of this series I will be looking at OpenALPR. The software is easy to use, comes with compiled binaries for windows and doesn't need a fancy GPU or anything like that. It also has bind ins for python and Go, which would ease integration into a live system."
language = "en_GB"
aliases = ['/220627-anpr1.html']
+++
